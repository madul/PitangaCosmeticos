...
export default function BuyPage(props){
  ...
  function sendToBack(e){
    ...
    fetch("http://pitanga/api/place-order.php", { method: "POST", body: new FormData(e.target) })
    .then(response => response.json())
    .then(result => { alert(result); setLinkTo(true)});
          ...
          <div id="orderModule">
            ...
            <Form.Row>
              <Form.Group as={Col}>
                ...
                <Form.Control defaultValue={user.user[0].name} id="name"name="name" placeholder="Nome"/>
              </Form.Group>
              
              <Form.Group as={Col}>
                <Form.Label>Sobrenome</Form.Label>
                <Form.Control defaultValue={user.user[0].surname}name="surname" placeholder="Sobrenome"/>
              </Form.Group>
            </Form.Row>
            <Form.Row>
              <Form.Group as={Col}>
                <Form.Label>Email</Form.Label>
                <Form.Control defaultValue={user.user[0].email}name="email" type="email" placeholder="Email"/>
              </Form.Group>
              <Form.Group as={Col}>
                <Form.Label>CPF</Form.Label>
                <Form.Control defaultValue={user.user[0].cpf}name="cpf" type="number"/>
              </Form.Group>
            </Form.Row>
            ...
            <Form.Row>
              <Form.Group as={Col}>
                ...
                <Form.Control defaultValue={user.user[0].zipCode} name="zipCode" type="number"/>
              </Form.Group>
              <Form.Group as={Col} xs={1}>
                <Form.Label>UF</Form.Label>
                <Form.Control defaultValue={user.user[0].state} name="uf" />
              </Form.Group>
              <Form.Group as={Col}>
                <Form.Label>Cidade</Form.Label>
                <Form.Control defaultValue={user.user[0].city} name="city" />
              </Form.Group>
            </Form.Row>
            ...
            <Form.Row>
              <Form.Group as={Col}>
                ...
                <Form.Control defaultValue={user.user[0].address} name="logradouro"/>
              </Form.Group>
              <Form.Group as={Col} xs={2}>
                <Form.Label>Número</Form.Label>
                <Form.Control defaultValue={user.user[0].addressNumber} name="address-number" type="number" />
              </Form.Group>
              <Form.Group as={Col} xs={3}>
                <Form.Label>Complemento</Form.Label>
                <Form.Control defaultValue={user.user[0].addressCompl} name="compl" />
              </Form.Group>
            </Form.Row>
